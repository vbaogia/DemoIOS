...
//                print("error is : \(error.localizedDescription)")
            ...
            DispatchQueue.main.async {
                //TO DO decode our result and send back to the user
    ...
    ///  function giup minh generate url request
    /// - Parameters:
    ///   - route: the path the resource in the backend
    ///   - method: type of request to be made
    ///   - parameters: whatever extra information u need to pass to the backend
    /// - Returns: URLRequest
